            ...
            <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
                <div class="row flex-grow">
                    <div class="col-lg-6 d-flex align-items-center justify-content-center">
                        <div class="auth-form-transparent text-left p-3">
                            <div class="brand-logo">
                                <img src="./assets/images/logotipos/logo-bellavista.png" alt="logo">
                            </div>
                            <h4>Bienvenido de vuelta!</h4>
                            <form class="pt-3">
                                <div class="form-group">
                                    <label for="exampleInputEmail">Cedula</label>
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control form-control-lg border-left-0"
                                            id="exampleInputEmail" placeholder="Cedula">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="my-3">
                                    <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn"
                                        href="../../index.html"
                                        style="background-color: #a54f03; border-color: white">LOGIN</a>
                                </div>
                    ...
                    <div class="col-lg-6 login-half-bg d-flex flex-row"
                        style="background:url('./assets/images/login/IMG_2342.jpg'); background-size: cover;">
                        <p class="text-white font-weight-medium text-center flex-grow align-self-end">Copyright &copy;
                            2024 Todos los Derechos Reservados. <br> Diseñado por: Juan José Rincón G.</p>
                    </div>
