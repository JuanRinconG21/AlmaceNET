<?php
 ...
 $sql = "SELECT * FROM area_trabajo_retro_kiosco WHERE estado=0";
                ...
                <div class="container-fluid">
                    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                            <h1 style="font-weight: bold; color: #ffff">Areas Retro y Kiosco</h1>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="card-description">
                                            Ingresa el Area que quieres agregar, Ejemplo: RetroExcavadora, Kiosco, ect.
                                        </p>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="exampleInputUsername2"
                                                        placeholder="Ejemplo: RetroExcavadora, Kiosco, ect.">
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive" style="width:98%; margin: 0 auto;">
                                    <table id="example" class="table table-hover">
                                        ...
                                        <tbody style="text-align: center;">
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $key['idArea_Trabajo_Retro']  ?></td>
