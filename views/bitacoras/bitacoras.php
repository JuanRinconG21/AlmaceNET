<?php
 ...
 $sql = "SELECT bitacoras.idBitacoras, bitacoras.fechaEjecucion, bitacoras.descripcion, bitacoras.rutaImagen, maquinaria_zona.nombreoZona FROM bitacoras INNER JOIN maquinaria_zona ON maquinaria_zona.idMaquinaria_Zona = bitacoras.Maquinaria_Zona_idMaquinaria_Zona";
 $stmt = $pdo->prepare($sql);
 $stmt->execute();
 $fila = $stmt->fetchAll(PDO::FETCH_ASSOC);

 $sql2 = "SELECT * FROM maquinaria_zona WHERE estado=0";
...
<body>
                ...
                <div class="container-fluid">
                    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                            <h1 style="font-weight: bold; color: #ffff">Bitacoras</h1>
                        </div>
            ...
            <nav class="bottom-navbar">
                <div class="container">
                    <ul class="nav page-navigation">
                        ...
                        <li class="nav-item">
                            <a href="./maquinaria-equipo.php" class="nav-link">
                            ...
                            <div class="submenu">
                                <ul class="submenu-item">
                                    <li class="nav-item">
                                        <a class="nav-link" href="./maquinaria-equipo.php">Administración de Maquinaria
                                            o Zona</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <select class="form-select" aria-label="Default select example">
                                        ...
                                        foreach ($fila as $key) {
                                        ?>
                                        <option value="<?php echo $key['nombreoZona'] ?>">
                                            <?php echo $key['nombreoZona'] ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: #0d6efd; color: #ffff">
                                            <h5 class="modal-title" id="exampleModalLabel">Agregar Bitacora
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                            <p class="card-description">
                                                Ingresa la bitacora correspondiente a la Maquina o Zona.
                                            </p>
                                            <form class="forms-sample mt-3">
                                                <div class="form-group">
                                                    <label for="exampleInputName1">Fecha de Mantenimiento:</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleSelectGender">Maquina</label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-4">
                                    <div class="card" style="width: 100%;">
                                        <img src="https://i.ytimg.com/vi/Pv4Op8B_A1s/maxresdefault.jpg"
                                            class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h5 class="card-title" style="color: black; margin-bottom: 0;">Fecha
                                                de
                                                Mantenimiento:
                                            </h5>
                                            <p class="mt-2"><?php echo $key['fechaEjecucion'] ?></p>
                                            <h5 class=" card-title" style="color: black; margin-bottom: 0;">
                                                Maquina o
                                                Zona:
                                                <h5>
                                                    <p class="mt-2"><?php echo $key['nombreoZona'] ?></p>
    ...
    <script src="../../assets/vendors/chartjs-plugin-datalabels/chartjs-plugin-datalabels.js">
    </script>
